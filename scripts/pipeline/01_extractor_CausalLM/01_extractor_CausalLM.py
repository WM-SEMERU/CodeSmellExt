...
def default_params(): 
    return {
        ...
        'callbacks_dir' : '/workspaces/CodeSmells/datax/code_smells/callbacks/pipeline',
...
def logit_extractor(model, batch, tf_encoded_inputs, from_index=0):
    ...
    """
    callbacks_dir = f"{params['callbacks_dir']}/{params['current_model']}_q_{params['quantization']}"
