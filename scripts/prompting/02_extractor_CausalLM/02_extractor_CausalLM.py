...
def default_params(): 
    return {
        ...
        'dataset': {
            ...
            'content_column': 'code',
            'sampling_size': 500,
            'prompt_id': 'P1', #['P1', 'P2', 'P3', 'P4']
            'prompt_column': 'prompt',
        },
        'logging_path': '/workspaces/CodeSmells/datax/code_smells/logs', 
        'callbacks_dir' : '/workspaces/CodeSmells/datax/code_smells/callbacks/prompts',
...
def logit_extractor(model, batch, tf_encoded_inputs, from_index=0):
    ...
    """
    callbacks_dir = f"{params['callbacks_dir']}/{params['dataset']['prompt_id']}/{params['current_model']}_q_{params['quantization']}"
